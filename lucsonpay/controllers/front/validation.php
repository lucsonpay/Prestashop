...
<div class="loader">
    <img src="https://www.lucsonpay.com/wp-content/uploads/2018/07/logo.png" class="centre-image">
</div>  
...
class LucsonPayValidationModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        //$merchant_website=$merchant_website."en/module/lucsonpay/validation";
        $merchant_website=$merchant_website."en/module/lucsonpay/thankyou";
        //test for redirect
       ...
       // @$pg_transaction->setCustShipName($_REQUEST['CUST_SHIP_NAME']);
        ...
        $this->setTemplate('module:lucsonpay/views/templates/front/payment_return.tpl');
